...
class RuleGen:
    ...
    def analyze_passwords_file(self,passwords_file):
        ...
        f = open(passwords_file,'r', encoding='utf-8', errors='ignore')
        ...
        #       optimal way.
        rules_file = open("%s.rule" % self.basename,'r', encoding='utf-8', errors='ignore')
        ...
        words_file = open("%s.word" % self.basename,'r', encoding='utf-8', errors='ignore')
